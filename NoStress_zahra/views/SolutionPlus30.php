...
<body class="solutions">
    ...
    <div class="container">
        ...
        <div class="containt-solutions">
            ...
            <div>
                ...
                <div>
                    <button class="btn-questionnaire" id="sommeil3">Sons de la nature</button>
                </div>

                <div>
                    <button class="btn-questionnaire" id="sommeil4">Yoga sérénité</button>
                </div>
    ...
    <script src ="../assets/scripts/solutionPlus30.js"></script>
</body>
</html>