...
<head>
    ...
    <title>Carte meditation Animal Totem</title>
...
<header>
        ...
        <div class="containt-relax">
                ...
                <div id="img-carte">
                    <img id="img-relax" src="../../NNS_Thais/asset/img/T_sommeil.png" alt="sommeil">
                </div>

                <div>
                    <h2>Méditation Animal Totem du Sommeil </h2>
                </div>
                ...
                <div>
                    <p id="para">
                        Dans cette méditation courte de 15 minutes, vous irez à la rencontre de votre animal totem du sommeil. Prenez le temps de vous détendre, de respirer et de rencontrer cet animal symbolique. Et laissez celui-ci vous emporter dans le monde du sommeil. Installez-vous confortablement et  appuyez sur commencer. Bonne nuit.

                    </p>
                </div>

                <div class="bouton">
                    <button class="btn-questionnaire" id="yogaCourt-btn">Commencer</button>
                </div>
            </div> 
        </div>
