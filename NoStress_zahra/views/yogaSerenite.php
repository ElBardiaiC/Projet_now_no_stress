...
<body class="solutions">
    ...
    <div class="container">
        ...
        <section class="containt">
            ...
            <div>
                <h2>Séance de yoga sérénité</h2>
            </div><br>
            
                <div>
                    <video controls="controls">
                        <source src="../assets/Medias/T_yoga_serenite.mp4">
                    </video> 
                </div>
    ...
    <div id="basDePageTension">
        ...
        <div class="retour">
            <a href="T_carteYogaSerenite.php"><img src="../assets/img/fleche-retour.png"id="retourFleche" ></a>
        </div>
